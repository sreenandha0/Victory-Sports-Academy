...
class EventRegistration(models.Model):
    ...
    child = models.ForeignKey(Child, on_delete=models.CASCADE, related_name='event_registrations')
    ...
    def __str__(self):
        return f"{self.child.name} registered for {self.event.title}"
...
class FeeAssignment(models.Model):
    ...
    def __str__(self):
        return f"{self.child.name} - {self.fee.title}"
